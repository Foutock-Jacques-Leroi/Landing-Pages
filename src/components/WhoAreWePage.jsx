    ...
    return (
        ...
        <div className='w-full h-screen px-4 py-3 bg-red-300'>
            <div className='px-2 m-3'>
                ...
                <div className='flex justify-center py-9 items-center max-sm:flex-wrap gap-6'>

                    <div className='h-90 w-full bg-amber-600 rounded-lg shadow-2xl'>
                        image
                    </div>


                    <div className='w-full h-fit'>
                        <h3 className='text-black text-shadow-lg font-light text-xl md:text-3xl sm:text-2xl py-5'>How we got that experience.</h3>
